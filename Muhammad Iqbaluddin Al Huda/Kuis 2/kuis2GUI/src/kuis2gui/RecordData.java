...
public class RecordData extends javax.swing.JFrame {
    ...
    public RecordData() {
        ...
        this.jTableHasil.setModel(model);
    ...
    private void ambil_data_tabel() {
        ...
        try {
            ...
            while (r.next()) {
                ...
                o[0] = r.getString("Angka 1");
                o[1] = r.getString("Angka 2");
                o[2] = r.getString("Operator");
                o[3] = r.getString("Hasil");
                model.addRow(o);
            }
//            String sqlkode = "Insert into anggota (angka1,angka2,operator,hasil) "
//                + "values ('" + k.inputText1.getText() + "',"
//                + "'" + k.inputText2.getText() + "',"
//                + "'" + k.operatorText.getPrototypeDisplayValue() + "')"
//                + "'" + k.hasiltext.getText() + "',";
            r.close();
            s.close();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jTableHasil);
