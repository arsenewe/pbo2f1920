...
public class TestBackendBuku {
    public static void main(String[] args) {
        ...
        Buku buku1 = new Buku(novel, "Timun Mas", "Bang Supit", "Elex Media");
        Buku buku2 = new Buku(referensi, "Metode Linier", "Alex Baldwin", "Springer");
        Buku buku3 = new Buku(novel, "Bintang Terang", "Mat Sewoot", "Erlangga");
        ...
        System.out.println(buku2.getPenulis());
    }
}
